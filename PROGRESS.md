...
**当前状态：v1.8.0 在分支 `latihan-kunci-jawaban` 上，等 Rae 在手机上看过再合。**
**线上仍是 v1.7.0。三课 67 页 + 总目录页，366 词，五语（中 / 日 / 英 / 越 / 波），音频 100%。**
...
## v1.8.0 做了什么（2026-09-07，分支 `latihan-kunci-jawaban`）
